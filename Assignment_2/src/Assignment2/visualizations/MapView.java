...
public class MapView extends Display implements Constants {

    public static final String ZIPCODES = "data/geodata.txt";
    ...
    */
    ...
    public MapView(final Table t) {
       ...
       VisualTable vt = m_vis.addTable(DATA, t, getDataSchema());
        ...
        vt.addColumn("city", String.class);
        // now add a formatted label to show within the visualization
        vt.addColumn("label", "CONCAT(CAP(city))");
      // vt.addColumn("label", "CONCAT(CAP(city),', ',STATE(state),' ',zipstr)");
        ...
        //Predicate loneResult = (Predicate)ExpressionParser.parse(
          //      "INGROUP('_search_') AND GROUPSIZE('_search_')=1");
        ...
        AxisLayout a1 = new AxisLayout(DATA,"latitude",Y_AXIS);
        AxisLayout a2 = new AxisLayout(DATA,"longitude",Y_AXIS); 
        ...
        SearchQueryBinding searchQ = new SearchQueryBinding(vt, "city");
    ...
    public static JFrame demo(String datafile) throws DataIOException {
        DelimitedTextTableReader tr = new DelimitedTextTableReader();
        Table t = tr.readTable(datafile);        
        MapView zd = new MapView(t);
